...
public class Constant {
    ...
    final public static String INVITE_SUBJECT = WOUApp.mPref.name().getOr("") + " invite you to join WOUchat";
    final public static String INVITE_TEXT = "You are invited to join WOUchat, please download at www.wouchat.com/app?" + WOUApp.mPref.userId().getOr(0);
