...
public class ProfileHeaderBehavior extends CoordinatorLayout.Behavior<HeaderView> {
    ...
    public ProfileHeaderBehavior(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
