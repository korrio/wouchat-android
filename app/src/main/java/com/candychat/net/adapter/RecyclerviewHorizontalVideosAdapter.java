...
public class RecyclerviewHorizontalVideosAdapter extends RecyclerView.Adapter<RecyclerviewHorizontalVideosAdapter.ViewHolder> {
    ...
    public RecyclerviewHorizontalVideosAdapter(Context context, List<MediaUrl> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View sView = mInflater.inflate(R.layout.item_video_new, parent, false);
