...
public class RecyclerviewHorizontalMediaAdapter extends RecyclerView.Adapter<RecyclerviewHorizontalMediaAdapter.ViewHolder> {
    ...
    public RecyclerviewHorizontalMediaAdapter(Context context, List<MediaUrl> list) {
