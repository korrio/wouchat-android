...
public class RecyclerViewTimelineGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewTimelineGridAdapter(List<Object> items, Context context) {
        this.items = items;
