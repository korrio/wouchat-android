...
public class MutiFriendsAdapter extends BaseAdapter {
    Context mContext;
    List<TheUser> list = new ArrayList<>();

    public MutiFriendsAdapter(Context context, List<TheUser> list) {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View convertView) {
            ...
            txt_msg = (TextView) convertView.findViewById(R.id.message);
