...
public class CaseInsensitiveAssetFontLoader implements ICustomFontLoader {
	...
	private static LruCache<Typeface, String> sTypefaceCache555 = new LruCache<Typeface, String>(
			24);
	...
	public HashMap<String, String> getFontList() {
		return mTypefacenameMapping;
	}
	...
	public String getTypeFaceName(Typeface typeface) {
		return sTypefaceCache555.get(typeface);
	}
