...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TITLE_OFFSET_DIPS = 3;
     ...
     * @param content
     */
    public void setCustomTabView(int layoutResId, int content) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = content;
    }
...
//        textView.setBackgroundColor(R.color.bg_horizontal_item);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i != 0) {
                BitmapWorkerTask task = new BitmapWorkerTask(tabTitleView);
                task.execute(0);
            }
            // TODO create image view by asynctask
    ...
    private void scrollToTab(int position, int extraOffset) {
        scrollToTab(position, extraOffset, true);
    }
...
//                mTabStrip.invalidate();
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            Bitmap bitmap = null;
            try {
                istr = assetManager.open("sticker/Sticker_layout_send_01.png");
