 ...
 * Created by dpizarro
 */
public class InviteAdapter extends RecyclerView.Adapter<InviteAdapter.PersonViewHolder> {

    List<Person> people;
    OnItemClickListener mItemClickListener;

    public InviteAdapter(List<Person> persons) {
        this.people = persons;
    }
    ...
    public void onBindViewHolder(PersonViewHolder personViewHolder, int i) {
        ...
        personViewHolder.personAge.setText(people.get(i).getAge());
        personViewHolder.personPhoto.setImageResource(people.get(i).getPhotoId());
